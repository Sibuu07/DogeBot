    ...
    const add = function (from, orangnya) {
      ...
      Sibu.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	...
        	grup = Sibu.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `  Inc.`, "footerText": "*_ _*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
   ...
   case 'bc':
      ...
      case 'broadcast':
        ...
        if (!mek.key.fromMe) return;
             ...
             Sibu.sendMessage(_.jid, bc, image, {quoted:fkontak,caption: `*「   BROADCASTING 」*\n\n${body.slice(4)}`})
