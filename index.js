...
const asw1 = 'https://screenrant.com/naruto-kakashi-question-mystery-answered/amp/'
    ...
    const add = function (from, orangnya) {
      ...
      Sibu.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	...
        	grup = Sibu.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `Sibu Bot Inc.`, "footerText": "*_Sibu Bot_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
remoteJid :"6289523258649-1604595598@g.us" }: {})
                    ...
                    },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(`./stik/thumb.jpeg`),"itemCount":10,"status":"INQUIRY","surface":"CATALOG","message":`Sibu Bot`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})}
...
"externalAdReply": {
                ...
                "title": `Whatsapp-BOT\nSibu Bot. (@nnda.krnwn_) •Instagram photos and Videos`,

                "body": "",

                "previewType": "PHOTO",

                "thumbnailUrl": "https://screenrant.com/naruto-kakashi-question-mystery-answered/amp/",
...
*Thank you for registering in the Sibu Bot Database*
...
*「 Sibu Bot 」*`
	    ...
	    // console.log(e)
			...
			reply(`*Thank you for being registered Sibu Bot*`)
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
  ...
  reply('http://instagram.com/sibssssssss/')
...
sendButMessage(from, menu, `Sibu Bot`, [
...
case 'script':
		...
		Sibu.sendMessage(from, { text: "https://github.com/Sibuu07/DogeBot", matchedText: 'nopee', description: "", title: "What are you doing?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
...
case 'mygithub':
  ...
  reply('https://github.com/Sibuu07')
    ...
    "hydratedButtons": [

      {
        ...
        "urlButton": {
          ...
          "url": "https://github.com/Sibuu07/DogeBot"
...
buttons = [{buttonId: `writelist`,buttonText:{displayText: `Write List🔖`},type:1}]
              ...
              buttonsMessage = {footerText:'Sibu Bot', imageMessage: imageMsg,
...
sendButMessage(from, tiyo, `Sibu Bot`, [
   ...
   case 'bc':
      ...
      case 'broadcast':
        ...
        if (!mek.key.fromMe) return;
             ...
             if (!isOwner) return  reply(mesisaowner)
             ...
             Sibu.sendMessage(_.jid, bc, image, {quoted:fkontak,caption: `*「 Sibu Bot BROADCASTING 」*\n\n${body.slice(4)}`})
...
case 'attp':
              ...
              break
				...
				anu = await fetchJson(`https://bx-hunter.herokuapp.com/api/resepmakanan?query=${teks}&apikey=${HunterApi}`, {method: 'get'})
					...
					Sibu.sendMessage(from, buff, image, {quoted: ftok, caption: hasilresep})
