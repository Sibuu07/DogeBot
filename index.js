    ...
    const add = function (from, orangnya) {
      ...
      Sibu.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	...
        	grup = Sibu.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `Sibu Bot Inc.`, "footerText": "*_𝐃𝐨𝐠𝐞 𝐁𝐨𝐭_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
   ...
   case 'bc':
      ...
      case 'broadcast':
        ...
        if (!mek.key.fromMe) return;
             ...
             Sibu.sendMessage(_.jid, bc, image, {quoted:fkontak,caption: `*「 𝐃𝐨𝐠𝐞 𝐁𝐨𝐭 BROADCASTING 」*\n\n${body.slice(4)}`})
