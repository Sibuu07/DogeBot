...
case 'script':
		case 'sc':
		case 'sourcecode':
		Sibu.sendMessage(from, { text: "https://github.com/DGSibu/DogeBot", matchedText: 'nopee', description: "", title: "What are you doing?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      case "setcmd":
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://github.com/DGSibu/DogeBot"
        },
        "index": 0
      }
    ]
