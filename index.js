...
const asw1 = 'https://i.ibb.co/Rpt2F7r/asw1.jpg'
...
download(url, "./stik" + names + ".png", async function () {
        ...
        exec(
          ...
          (err) => {
            ...
            𝐒𝐢𝐛𝐮.sendMessage(to, media, MessageType.sticker, { quoted: mek });
...
𝐒𝐢𝐛𝐮.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      𝐒𝐢𝐛𝐮.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = 𝐒𝐢𝐛𝐮.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `𝐒𝐈𝐁𝐔 𝐁𝐎𝐓 Inc.`, "footerText": "*_𝐒𝐢𝐛𝐮 𝐁𝐨𝐭_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\n𝐒𝐢𝐛𝐮 𝐁𝐨𝐭. (@__aitzaz__) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
                "thumbnailUrl": "https://i.ibb.co/64WjBM4/Bot-Image.jpg",
                "thumbnail": fake,
                "sourceUrl": ``
...
"mediaType": "2",
"thumbnailUrl": "https://i.ibb.co/64WjBM4/Bot-Image.jpg",
"mediaUrl": "https://www.youtube.com/channel/UCp7XxNRFbignFOpp7RWD4Bw",
...
case 'buglink':
            ...
            "externalAdReply": {
                ...
                "sourceUrl": "https://www.youtube.com/channel/UCp7XxNRFbignFOpp7RWD4Bw"}}})
                break
        case 'bugbutton':
        if (!isOwner && !mek.key.fromMe) return reply('Only owner can use this feature')
        𝐒𝐢𝐛𝐮.toggleDisappearingMessages(from, 0)
...
case 'script':
		case 'sc':
		case 'sourcecode':
		𝐒𝐢𝐛𝐮.sendMessage(from, { text: "https://github.com/Sibuu07/DogeBot", matchedText: 'nopee', description: "", title: "What are you doing?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      case "setcmd":
...
if (Number(args[0]) >= 50) return reply('Most!')
	  ...
	  𝐒𝐢𝐛𝐮.sendMessage(from, teks, MessageType.text)
	  }
...
case 'mygithub':
  reply('https://github.com/Sibuu07/DogeBot')
					break;
   case 'ss':
      reply(mess.wait)
...
case 'attp':
              ...
              break
				...
				anu = await fetchJson(`https://bx-hunter.herokuapp.com/api/resepmakanan?query=${teks}&apikey=${HunterApi}`, {method: 'get'})
					...
					𝐒𝐢𝐛𝐮.sendMessage(from, buff, image, {quoted: ftok, caption: hasilresep})
					break 
					case 'githubstalk':
